...
export function SettingsPanel() {
  ...
  return (
    <div className="body">
      ...
      {/* NBME exam # lives inline at the top of the LogCard now — no
          duplicate field here. (The setting itself is still in storage and
          can be edited from any NBME question.) */}
